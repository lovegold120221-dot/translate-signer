...
describe('LanguageSelectorComponent', () => {
  ...
  it('should fall back to the signed language abbreviation when a translation is missing', () => {
    component.translationKey = 'signedLanguagesShort';
    component.languages = ['vgt'];

    expect(component.langName('vgt')).toEqual('VGT');
  });
});
